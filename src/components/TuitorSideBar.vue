      ...
      <ul class="space-y-2">
         ...
         <li>
            <router-link :to="{ name: 'course-list' }"
               ...
               <span
                  class="inline-flex justify-center items-center px-2 ml-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="w-6 h-6">
            ...
            <ul id="dropdown-example" class="py-2 space-y-2">
               ...
               <li>
                  <router-link :to="{ name: 'my-course-list' }"
                     class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                     Manage Course</router-link>
               </li>
            </ul>
         </li>
         ...
         <li>
            <a href="#"
               ...
               <span class="flex-1 ml-3 whitespace-nowrap font-base">Quiz</span>
